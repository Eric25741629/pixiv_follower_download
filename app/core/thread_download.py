...
from app.core.step4_init import _Step4InitMixin
...
class download_thread(PauseableThread, _FilenameMixin, _JXLMixin,
    ...
    # __init__ helper group (_init_basic_options, _resolve_intra_pid_wait_range,
    # _load_legacy_pid_cooldown_avg, _init_filter_state) moved to
    # step4_init._Step4InitMixin (file-size refactor). Inherited unchanged.
    ...
    # Per-run state + task loading (_init_step4_paths_and_state,
    # _load_initial_exist_pid_set, _warn_if_meta_empty_with_like_filter,
    # _sql_like_min, _read_all_url_file_into_state, _enqueue_retriable_failures,
    # _requeue_failed_page, _emit_step4_init_diag) moved to
    # step4_init._Step4InitMixin (file-size refactor). Inherited unchanged.
